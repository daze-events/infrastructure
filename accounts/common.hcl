...
locals {
  ...
  config_s3_bucket_name = "dz-logs-config"

  # The name of the S3 bucket in the Logs account where AWS CloudTrail will report its findings.
  cloudtrail_s3_bucket_name = "dz-cloudtrail"

  # The ARN of the S3 bucket in the Logs account where AWS CloudTrail will report its findings.
  cloudtrail_kms_key_arn = "arn:aws:kms:eu-central-1:536049262542:key/5467bd7b-0b4a-4f23-bf72-3602d4ea4bb3"
